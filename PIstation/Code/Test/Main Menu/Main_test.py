...
button_one = Button(window, image=Play, height=bh, width=bwidth, command=Load, highlightthickness=1).grid(row=0, column=4, columnspan=4, sticky=N)
button_one = Button(window, image=Code, height=bh, width=bwidth, command=hello, bg="white", highlightthickness=1).grid(row=1, column=4, columnspan=4, sticky=N)
button_one = Button(window, image=Exit, height=bh, width=bwidth, command=hello, highlightthickness=1).grid(row=2, column=4, columnspan=4, sticky=N)
